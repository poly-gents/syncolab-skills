...
description: "Add logging, metrics, and monitoring dashboards"
---
...
Add logging, metrics, and monitoring dashboards

This skill provides operational guidance for Add Observability, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Add Observability.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Add Observability or covered by a more specific skill.
...
1. Confirm the request maps to Add Observability and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`add-observability`).
