---
name: annotate-specs
description: "Add implementation notes and measurements to design specs"
---
...
Add implementation notes and measurements to design specs

This skill provides operational guidance for Annotate Specs, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Annotate Specs.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Annotate Specs or covered by a more specific skill.
...
1. Confirm the request maps to Annotate Specs and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`annotate-specs`).
