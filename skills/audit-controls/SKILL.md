---
name: audit-controls
description: "Review security controls against compliance frameworks"
---
...
Review security controls against compliance frameworks

This skill provides operational guidance for Audit Controls, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Audit Controls.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Audit Controls or covered by a more specific skill.
...
1. Confirm the request maps to Audit Controls and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`audit-controls`).
