---
name: book-meetings
description: "Schedule qualified meetings from outbound pipeline"
---
...
Schedule qualified meetings from outbound pipeline

This skill provides operational guidance for Book Meetings, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Book Meetings.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Book Meetings or covered by a more specific skill.
...
1. Confirm the request maps to Book Meetings and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`book-meetings`).
