---
name: coordinate-ebrs
description: "Prepare and coordinate executive business reviews"
---
...
Prepare and coordinate executive business reviews

This skill provides operational guidance for Coordinate EBRs, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Coordinate EBRs.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Coordinate EBRs or covered by a more specific skill.
...
1. Confirm the request maps to Coordinate EBRs and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`coordinate-ebrs`).
