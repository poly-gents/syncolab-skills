---
name: coordinate-incidents
description: "Triage and coordinate incident response across teams"
---
...
Triage and coordinate incident response across teams

This skill provides operational guidance for Coordinate Incidents, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Coordinate Incidents.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Coordinate Incidents or covered by a more specific skill.
...
1. Confirm the request maps to Coordinate Incidents and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`coordinate-incidents`).
