...
description: "Coordinate meetings across time zones with agendas and context"
---
...
Coordinate meetings across time zones with agendas and context

This skill provides operational guidance for Coordinate Meetings, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Coordinate Meetings.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Coordinate Meetings or covered by a more specific skill.
...
1. Confirm the request maps to Coordinate Meetings and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`coordinate-meetings`).
