---
name: coordinate-releases
description: "Plan and execute deployment rollouts"
---
...
This skill provides operational guidance for Coordinate Releases, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Coordinate Releases.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Coordinate Releases or covered by a more specific skill.
...
1. Confirm the request maps to Coordinate Releases and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`coordinate-releases`).
