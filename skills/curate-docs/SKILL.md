---
name: curate-docs
description: "Organize and maintain a consistent knowledge base"
---
...
Organize and maintain a consistent knowledge base

This skill provides operational guidance for Curate Docs, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Curate Docs.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Curate Docs or covered by a more specific skill.
...
1. Confirm the request maps to Curate Docs and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`curate-docs`).
