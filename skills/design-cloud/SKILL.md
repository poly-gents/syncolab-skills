---
name: design-cloud
description: "Design cloud topologies and reference architectures"
---
...
Design cloud topologies and reference architectures

This skill provides operational guidance for Design Cloud, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Design Cloud.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Design Cloud or covered by a more specific skill.
...
1. Confirm the request maps to Design Cloud and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`design-cloud`).
