...
description: "Design, document, and test API endpoints"
---
...
Design, document, and test API endpoints

This skill provides operational guidance for Design Endpoints, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Design Endpoints.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Design Endpoints or covered by a more specific skill.
...
1. Confirm the request maps to Design Endpoints and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`design-endpoints`).
