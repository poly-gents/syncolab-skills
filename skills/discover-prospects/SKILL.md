...
description: "Find and qualify prospects matching ideal customer profile"
---
...
Find and qualify prospects matching ideal customer profile

This skill provides operational guidance for Discover Prospects, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Discover Prospects.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Discover Prospects or covered by a more specific skill.
...
1. Confirm the request maps to Discover Prospects and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`discover-prospects`).
