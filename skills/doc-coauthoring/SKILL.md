...
This skill provides operational guidance for Doc Co-Authoring, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Doc Co-Authoring.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Doc Co-Authoring or covered by a more specific skill.
...
1. Confirm the request maps to Doc Co-Authoring and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`doc-coauthoring`).
