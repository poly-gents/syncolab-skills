...
description: "Create and maintain operational runbook documentation"
---
...
Create and maintain operational runbook documentation

This skill provides operational guidance for Document Runbooks, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Document Runbooks.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Document Runbooks or covered by a more specific skill.
...
1. Confirm the request maps to Document Runbooks and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`document-runbooks`).
