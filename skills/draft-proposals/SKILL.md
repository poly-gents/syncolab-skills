...
description: "Author partnership and business proposals"
---
...
Author partnership and business proposals

This skill provides operational guidance for Draft Proposals, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Draft Proposals.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Draft Proposals or covered by a more specific skill.
...
1. Confirm the request maps to Draft Proposals and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`draft-proposals`).
