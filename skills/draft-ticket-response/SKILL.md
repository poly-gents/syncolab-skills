...
description: "Write empathetic, accurate replies to support tickets"
---
...
Write empathetic, accurate replies to support tickets

This skill provides operational guidance for Draft Ticket Response, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Draft Ticket Response.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Draft Ticket Response or covered by a more specific skill.
...
1. Confirm the request maps to Draft Ticket Response and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`draft-ticket-response`).
