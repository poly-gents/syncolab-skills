...
description: "Audit and improve UI accessibility compliance"
---
...
Audit and improve UI accessibility compliance

This skill provides operational guidance for Ensure Accessibility, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Ensure Accessibility.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Ensure Accessibility or covered by a more specific skill.
...
1. Confirm the request maps to Ensure Accessibility and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`ensure-accessibility`).
