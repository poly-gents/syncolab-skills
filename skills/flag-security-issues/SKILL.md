---
name: flag-security-issues
description: "Highlight security vulnerabilities in code changes"
---
...
Highlight security vulnerabilities in code changes

This skill provides operational guidance for Flag Security Issues, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Flag Security Issues.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Flag Security Issues or covered by a more specific skill.
...
1. Confirm the request maps to Flag Security Issues and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`flag-security-issues`).
