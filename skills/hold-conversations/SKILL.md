---
name: hold-conversations
description: "Natural, real-time voice conversations with callers"
---
...
Natural, real-time voice conversations with callers

This skill provides operational guidance for Hold Conversations, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Hold Conversations.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Hold Conversations or covered by a more specific skill.
...
1. Confirm the request maps to Hold Conversations and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`hold-conversations`).
