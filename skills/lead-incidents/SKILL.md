---
name: lead-incidents
description: "Command incident response calls and coordinate resolution"
---
...
Command incident response calls and coordinate resolution

This skill provides operational guidance for Lead Incidents, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Lead Incidents.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Lead Incidents or covered by a more specific skill.
...
1. Confirm the request maps to Lead Incidents and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`lead-incidents`).
