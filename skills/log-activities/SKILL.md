---
name: log-activities
description: "Record call notes and touchpoints in CRM"
---
...
Record call notes and touchpoints in CRM

This skill provides operational guidance for Log Activities, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Log Activities.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Log Activities or covered by a more specific skill.
...
1. Confirm the request maps to Log Activities and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`log-activities`).
