---
name: monitor-health
description: "Track account or system health signals and flag risks"
---
...
Track account or system health signals and flag risks

This skill provides operational guidance for Monitor Health, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Monitor Health.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Monitor Health or covered by a more specific skill.
...
1. Confirm the request maps to Monitor Health and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`monitor-health`).
