...
description: "Track and visualize agent and system performance."
---
...
Track and visualize agent and system performance.

This skill provides operational guidance for Monitor Performance, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Monitor Performance.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Monitor Performance or covered by a more specific skill.
...
1. Confirm the request maps to Monitor Performance and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`monitor-performance`).
