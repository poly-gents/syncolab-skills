---
name: monitor-slos
description: "Track SLIs, SLOs, and error budgets for services"
---
...
Track SLIs, SLOs, and error budgets for services

This skill provides operational guidance for Monitor SLOs, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Monitor SLOs.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Monitor SLOs or covered by a more specific skill.
...
1. Confirm the request maps to Monitor SLOs and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`monitor-slos`).
