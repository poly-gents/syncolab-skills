...
description: "Improve content for search engine visibility"
---
...
Improve content for search engine visibility

This skill provides operational guidance for Optimize for SEO, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Optimize for SEO.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Optimize for SEO or covered by a more specific skill.
...
1. Confirm the request maps to Optimize for SEO and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`optimize-for-seo`).
