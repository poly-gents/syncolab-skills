---
name: organize-drive
description: "Organize and maintain shared drive folders and files"
---
...
Organize and maintain shared drive folders and files

This skill provides operational guidance for Organize Drive, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Organize Drive.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Organize Drive or covered by a more specific skill.
...
1. Confirm the request maps to Organize Drive and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`organize-drive`).
