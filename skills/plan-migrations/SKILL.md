...
description: "Design and coordinate database schema migrations"
---
...
Design and coordinate database schema migrations

This skill provides operational guidance for Plan Migrations, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Plan Migrations.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Plan Migrations or covered by a more specific skill.
...
1. Confirm the request maps to Plan Migrations and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`plan-migrations`).
