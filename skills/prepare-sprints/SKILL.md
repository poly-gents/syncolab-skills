---
name: prepare-sprints
description: "Plan sprints with capacity, goals, and backlog selection"
---
...
1. Confirm the request maps to Prepare Sprints and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`prepare-sprints`).
