---
name: produce-mockups
description: "Create high-fidelity UI mockups and design comps"
---
...
Create high-fidelity UI mockups and design comps

This skill provides operational guidance for Produce Mockups, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Produce Mockups.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Produce Mockups or covered by a more specific skill.
...
1. Confirm the request maps to Produce Mockups and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`produce-mockups`).
