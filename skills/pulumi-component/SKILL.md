...
description: "Author reusable Pulumi ComponentResource classes."
---
...
Author reusable Pulumi ComponentResource classes.

This skill provides operational guidance for Pulumi Component, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Pulumi Component.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Pulumi Component or covered by a more specific skill.
...
1. Confirm the request maps to Pulumi Component and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`pulumi-component`).
