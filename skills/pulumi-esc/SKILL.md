---
name: pulumi-esc
description: "Use Pulumi ESC for environments, secrets, and configuration."
---
...
Use Pulumi ESC for environments, secrets, and configuration.

This skill provides operational guidance for Pulumi ESC, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Pulumi ESC.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Pulumi ESC or covered by a more specific skill.
...
1. Confirm the request maps to Pulumi ESC and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`pulumi-esc`).
