...
description: "Evaluate potential partners for strategic fit"
---
...
Evaluate potential partners for strategic fit

This skill provides operational guidance for Research Partners, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Research Partners.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Research Partners or covered by a more specific skill.
...
1. Confirm the request maps to Research Partners and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`research-partners`).
