...
description: "Evaluate technical proposals against standards and patterns"
---
...
Evaluate technical proposals against standards and patterns

This skill provides operational guidance for Review Proposals, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Review Proposals.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Review Proposals or covered by a more specific skill.
...
1. Confirm the request maps to Review Proposals and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`review-proposals`).
