---
name: score-leads
description: "Score prospects by likelihood to convert"
---
...
Score prospects by likelihood to convert

This skill provides operational guidance for Score Leads, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Score Leads.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Score Leads or covered by a more specific skill.
...
1. Confirm the request maps to Score Leads and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`score-leads`).
