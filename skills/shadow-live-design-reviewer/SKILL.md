---
name: shadow-live-design-reviewer
description: "Live or staged UI review — flows, visuals, and responsiveness against intent."
---

# Shadow Live Design Reviewer

## Purpose

Live or staged UI review — flows, visuals, and responsiveness against intent.

This skill provides operational guidance for Shadow Live Design Reviewer, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Shadow Live Design Reviewer.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Shadow Live Design Reviewer or covered by a more specific skill.
...
1. Confirm the request maps to Shadow Live Design Reviewer and required tools are available.
...
- Walk critical user journeys in staging or prod-like build
- Capture issues with URL/route, viewport, repro
- Check responsive breakpoints and keyboard paths
- Compare to design spec or agreed acceptance criteria

Output: prioritized punch list with screenshots.
...
- Legacy content migrated from `skills/old_skills.json` (`shadow-live-design-reviewer`).
