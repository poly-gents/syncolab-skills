---
name: shadow-perf-engineer
description: "Performance and benchmarking — budgets, profiling mindset, and regression detection."
---
...
1. Confirm the request maps to Shadow Performance Engineer and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`shadow-perf-engineer`).
