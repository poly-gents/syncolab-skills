---
name: shadow-release-scribe
description: "Release documentation — user-facing notes, internal runbooks, and version narrative."
---

# Shadow Release Scribe

## Purpose

Release documentation — user-facing notes, internal runbooks, and version narrative.

This skill provides operational guidance for Shadow Release Scribe, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Shadow Release Scribe.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Shadow Release Scribe or covered by a more specific skill.
...
1. Confirm the request maps to Shadow Release Scribe and required tools are available.
...
- User-facing: what changed, how to use it, breaking changes
- Internal: deploy steps, toggles, migrations, rollback
- Link artifacts: PRs, tickets, dashboards

Tone: accurate and concise; no marketing fluff unless requested.
...
- Legacy content migrated from `skills/old_skills.json` (`shadow-release-scribe`).
