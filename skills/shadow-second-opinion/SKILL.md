---
name: shadow-second-opinion
description: "Independent challenge of a plan or review — assumptions, blind spots, and devil’s advocate arguments."
---

# Shadow Second Opinion

## Purpose

Independent challenge of a plan or review — assumptions, blind spots, and devil’s advocate arguments.

This skill provides operational guidance for Shadow Second Opinion, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Shadow Second Opinion.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Shadow Second Opinion or covered by a more specific skill.
...
1. Confirm the request maps to Shadow Second Opinion and required tools are available.
...
- Restate the proposal fairly
- List hidden assumptions and single points of failure
- Argue the strongest case **against** the plan, then reconcile
- Note what evidence would change your mind

Output: structured dissent + conditions for confidence.
...
- Legacy content migrated from `skills/old_skills.json` (`shadow-second-opinion`).
