---
name: tell-data-stories
description: "Transform data findings into narrative insights"
---
...
This skill provides operational guidance for Tell Data Stories, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Tell Data Stories.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Tell Data Stories or covered by a more specific skill.
...
1. Confirm the request maps to Tell Data Stories and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`tell-data-stories`).
