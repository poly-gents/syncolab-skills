---
name: track-risks
description: "Maintain and prioritize the security risk register"
---
...
This skill provides operational guidance for Track Risks, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Track Risks.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Track Risks or covered by a more specific skill.
...
1. Confirm the request maps to Track Risks and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`track-risks`).
