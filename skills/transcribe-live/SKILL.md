...
description: "Real-time speech-to-text transcription of calls"
---
...
This skill provides operational guidance for Transcribe Live, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Transcribe Live.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Transcribe Live or covered by a more specific skill.
...
1. Confirm the request maps to Transcribe Live and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`transcribe-live`).
