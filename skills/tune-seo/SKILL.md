---
name: tune-seo
description: "Optimize website metadata and structure for search"
---
...
This skill provides operational guidance for Tune SEO, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Tune SEO.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Tune SEO or covered by a more specific skill.
...
1. Confirm the request maps to Tune SEO and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`tune-seo`).
