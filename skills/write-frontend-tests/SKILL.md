...
description: "Create end-to-end and visual regression tests"
---
...
This skill provides operational guidance for Write Frontend Tests, including tool usage patterns, workflows, and quality expectations aligned with Syncolab skill standards.

## When to Use

- Use when the user needs help with Write Frontend Tests.
- When integrations for this domain are available and the task matches the workflows below.

## When NOT to Use

- When the task is unrelated to Write Frontend Tests or covered by a more specific skill.
...
1. Confirm the request maps to Write Frontend Tests and required tools are available.
...
- Legacy content migrated from `skills/old_skills.json` (`write-frontend-tests`).
