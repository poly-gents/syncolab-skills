...
- When the task is unrelated to Writing Plans or covered by a more specific skill.
...
1. Confirm the request maps to Writing Plans and required tools are available.
